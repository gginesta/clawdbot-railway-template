...
## 📧 Gmail — ⚠️ BROKEN until Feb 19

| What | Value |
|------|-------|
| My email | `ggv.molt@gmail.com` |
| Guillermo's | `guillermo.ginesta@gmail.com` |
...
**Auth:** OAuth (guillermo.ginesta@gmail.com) — preferred over token
**Token:** `43d18daf-9d26-4c19-bd0b-74b5cc60306a`
**If expired:** `railway login --browserless` (PTY + 120s)
