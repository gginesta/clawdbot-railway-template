...
for dir in /data/.openclaw /data/workspace /data/.syncthing /data/npm /data/.npm /data/pnpm /data/pnpm-store /data/.config /data/.cache /data/.local /data/shared/logs; do
  if [ -e "$dir" ]; then
